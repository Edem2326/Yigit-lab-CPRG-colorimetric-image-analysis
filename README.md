...
2. Download the MATLAB code ‘CPRG_CIElab_analysis.mfile’ and save it  in the directory.
3. Download and save the example image file. [CPRG image 2 x 2].
4. In MATLAB,  code is annotated to show experimental procedures. You an run the code to see you result.
